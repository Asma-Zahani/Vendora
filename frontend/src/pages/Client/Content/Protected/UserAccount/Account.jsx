                ...
                <div className="grid grid-cols-3 gap-6">
                    <div className="col-span-1 w-full py-2">
                        <div className="overflow-hidden bg-customLight dark:bg-customDark border border-contentLight dark:border-borderDark rounded-lg p-6 shadow-sm">
                            <h1 className="text-lg font-semibold mb-4">Mon Profile</h1>
                            <div className="grid grid-cols-1 gap-4 rounded-lg">
                                ...
                                <div className="mt-4">
                                    <a href="#order-history" className="text-blue-500 hover:text-blue-700">Voir l&apos;historique des commandes</a>
                                </div>
                            </div>
                        </div>
                    </div>
