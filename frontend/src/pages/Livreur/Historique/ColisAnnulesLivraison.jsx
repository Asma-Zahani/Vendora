...
const ColisAnnulesLivraison = () => {
  const [selectedFilter, setSelectedFilter] = useState("Annulée");
  ...
  return (
    <>
      ...
      <EntityManager filtres={filtres} notAdd={true} columns={columns} fields={fields} label="commandeLivreurs" identifiant="commande_id" formData={formData} setFormData={setFormData} actionList={["view", "facture"]} />
    </>
  );
};

export default ColisAnnulesLivraison;