...
const Produits = () => {
  ...
  const fields = [
    ...
    { label: "Sous Catégorie", key: "sous_categorie_id", type: "dropdown", options: sousCategories.map(sousCategorie => ({ value: sousCategorie.sous_categorie_id, label: sousCategorie?.titre + ' - ' + sousCategorie.titre_categorie })) },
