...
const ColisPrets = () => {
  ...
  const fields = [
    { label: "État Commande", key: "etatCommande", type: "dropdown", options: etatCommandeOptions.filter(option => option.value === 'Préparée' || option.value === 'Retirée' || option.value === 'Annulée') }
  ];
