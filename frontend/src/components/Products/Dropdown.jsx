...
const Dropdown = ({ isOpen, toggleOpen, categories, brands, colors , selectedCategories, toggleCategory, selectedBrands, toggleBrand , selectedColors, toggleColor , maxPrice, setMaxPrice}) => {
  ...
  return (
    <div className="relative">
      <div className="w-74 sm:w-64 flex items-center justify-between cursor-pointer border border-gray-300 dark:border-borderDark bg-customLight dark:bg-customDark rounded-lg px-4 py-2 shadow-sm hover:shadow-md transition duration-200" onClick={toggleOpen}>
