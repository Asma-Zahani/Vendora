...
const UserAction = ({ home }) => {
    ...
    return (
        <div className="relative group flex items-center dark:border-borderDark pl-4 -my-4">
            ...
            {home ?
                <div className="lg:flex hidden flex-col items-start justify-center pl-4 -my-3"> {/* pl-4 -my-3 */}
            ...
            <ul className={`absolute hidden group-hover:flex flex-col bg-contentLight dark:bg-contentDark shadow-md mt-2 p-2 rounded w-40 z-10 top-[60px] ${home ? "right-[-20px]" : "right-[0px]"}`}>
