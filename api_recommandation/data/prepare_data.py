...
def prepare_data():
    ...
    try:
        ...
        product_df = pd.read_csv(products_path, encoding='latin1')
        ...
        df = interactions_df.merge(user_df, on='user_id').merge(product_df, on='product_id')
        
        return df, user_df, product_df
